...
const CARDS = [
  { label: 'قائمة المتدربين',   to: '/trainer/infostrainee' },
  { label: 'تقييم المتدربين', to: '/trainer/evaluationtrainee'}, // alias OK
  { label: 'النتائج النهائية',   to: '/trainer/resultattrainee' },
];
