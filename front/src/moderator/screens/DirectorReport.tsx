// src/screens/ModeratorDirectorReport.tsx
...
export default function ModeratorDirectorReport(): React.JSX.Element {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // 2) Rapport du directeur (endpoint à adapter si besoin)
        const r = await fetch(
          `${API_BASE}/reports/formations/${formationId}?role=director&ts=${Date.now()}`,
          { headers: headers(), cache: 'no-store' }
        );
        ...
        setErr(e?.message || 'تعذّر تحميل تقرير قائد الدراسة');
      } finally {
        setLoading(false);
      }
    })();
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 12, fontSize: 14, color: '#4b5563' }}>
        هذا الفضاء مخصص لعرض تقرير <strong>قائد الدراسة</strong> حول الدورة.
      </div>
        ...
        <>
          {!report && (
            <div style={{ color: '#9ca3af', marginTop: 8 }}>
              لا يوجد تقرير قائد دراسة متاح لهذه الدراسة.
            </div>
          )}
          ...
          {report && (
            <div style={styles.card}>
              <div style={styles.section}>
                <div style={styles.sectionTitle}>ملاحظات حول المتدربين  </div>
              ...
              <div style={styles.section}>
                <div style={styles.sectionTitle}>تقييم قيادة الدراسة</div>
                <div style={styles.sectionBody}>
              ...
              <div style={styles.section}>
                <div style={styles.sectionTitle}>ملاحظات و توصيات عامة</div>
                <div style={styles.sectionBody}>
...
/* ---------- styles (identiques au coach report pour cohérence) ---------- */
